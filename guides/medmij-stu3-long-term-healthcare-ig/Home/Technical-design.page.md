...
Note that in addition to this design, the (technical) guidelines as specified in the [MedMij STU3 Core IG](https://simplifier.net/guide/medmij-stu3-core-ig?version=1.1.1) and the [MedMij FHIR IG for STU3, version 2020.02](https://informatiestandaarden.nictiz.nl/wiki/MedMij:V2020.02/FHIR_IG) apply, the latter of which is published by Nictiz.
...
The BgLZ+ data is defined and exchanged in a granular manner, which means that for each CIM that is part of the BgLZ+, a separate (granular) data service is defined. Granular exchange allows the PHR to retrieve individual data services that are part of BgLZ+ through targeted search interactions, in accordance with the general guidance and profiles defined in the [MedMij STU3 Core IG](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-exchange?version=1.1.1).
...
| --- | --- | --- | --- |
| 900000404 | [Retrieve MedMij Core - Alert (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-Alert?version=1.1.1) | Verzamelen MedMij Core - Alert (zib2017/STU3) | 1.0.0-rc.1 |
| 900000401 | [Retrieve MedMij Core - Blood pressure (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-BloodPressure?version=1.1.1) | Verzamelen MedMij Core - Bloeddruk (zib2017/STU3) | 1.0.0-rc.1 |
| 900000402 | [Retrieve MedMij Core - Body height (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-BodyHeight?version=1.1.1) | Verzamelen MedMij Core - Lichaamslengte (zib2017/STU3) | 1.0.0-rc.1 |
| 900000409 | [Retrieve MedMij Core - Body temperature (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-BodyTemperature?version=1.1.1) | Verzamelen MedMij Core - Lichaamstemperatuur (zib2017/STU3) | 1.0.0-rc.1 |
| 900000403 | [Retrieve MedMij Core - Body weight (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-BodyWeight?version=1.1.1) | Verzamelen MedMij Core - Lichaamsgewicht (zib2017/STU3) | 1.0.0-rc.1 |
| 900000410 | [Retrieve MedMij Core - Fluid balance (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-FluidBalance?version=1.1.1) | Verzamelen MedMij Core - Vochtbalans (zib2017/STU3) | 1.0.0-rc.1 |
| 900000406 | [Retrieve MedMij Core - Living situation (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-LivingSituation?version=1.1.1) | Verzamelen MedMij Core - Woonsituatie (zib2017/STU3) | 1.0.0-rc.1 |
| 900000405 | [Retrieve MedMij Core - Nutrition advice (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-NutritionAdvice?version=1.1.1) | Verzamelen MedMij Core - Voedingsadvies (zib2017/STU3) | 1.0.0-rc.1 |
| 900000407 | [Retrieve MedMij Core - Payer (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-Payer?version=1.1.1) | Verzamelen MedMij Core - Betaler (zib2017/STU3) | 1.0.0-rc.1 |
| 900000412 | [Retrieve MedMij Core - Pulse rate (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-PulseRate?version=1.1.1) | Verzamelen MedMij Core - Polsfrequentie (zib2017/STU3) | 1.0.0-rc.1 |
| 900000411 | [Retrieve MedMij Core - Respiration (zib2017/STU3)](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-Data-Service-Index/MedMij-Core-Respiration?version=1.1.1) | Verzamelen MedMij Core - Ademhaling (zib2017/STU3) | 1.0.0-rc.1 |
...
| 900000413 | {{pagelink: NursingReport, text: Retrieve Long-term Healthcare - Nursing report}} | Verzamelen Langdurige Zorg - Dagrapportage | 1.0.0-rc.1 |

**Table 2: Granular data services applicable for BgLZ+**

The technical specifications with respect to the request message executed by the PHR and the response message of the XIS are detailed in the [MedMij STU3 Core IG](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-exchange?version=1.1.1#GeneralTechnicalSpecifications).