...
- **Technical specification**
    ...
    - **Must Support** - the elements that have to be supported in the manner described [here](https://simplifier.net/guide/medmij-stu3-core-ig/Home/Granular-exchange?version=1.0.0#MustSupport).
